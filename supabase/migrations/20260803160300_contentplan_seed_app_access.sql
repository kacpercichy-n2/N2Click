...
-- zmieniają się w żaden inny sposób. Lista zawiera też 'clarity': żywa baza
-- dopuściła ją migracją 20260731101244_core_app_access_allow_clarity i
-- odtworzenie CHECK-a bez niej cofałoby tamtą decyzję (korekta 2026-08-04,
-- wykryta przy aplikowaniu — pierwotna wersja pliku wycinała 'clarity').
--
...
alter table core.app_access
  add constraint app_access_app_check check (app in ('n2click', 'blogoapp', 'clarity', 'contentplan'));
