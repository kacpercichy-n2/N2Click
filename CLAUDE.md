# N2click Planner — agent handoff & project guide
...
- `npm run dev` (port 5173, launch config in `.claude/launch.json` as `n2click-dev`), `npx tsc --noEmit`, `npm run build`. All three must pass before you finish any change.
